...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Offset.mk dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/main.p1: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=32 --float=32 --emi=wordwrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/MccGenerated" -I"../Includes/Usb" -I"../Includes/Usb/framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/main.p1  main.c 
...
${OBJECTDIR}/_ext/1843106274/usb_device.p1: ../Includes/Usb/framework/usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1843106274" 
	@${RM} ${OBJECTDIR}/_ext/1843106274/usb_device.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1843106274/usb_device.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=32 --float=32 --emi=wordwrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/MccGenerated" -I"../Includes/Usb" -I"../Includes/Usb/framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1843106274/usb_device.p1  ../Includes/Usb/framework/usb_device.c 
	@-${MV} ${OBJECTDIR}/_ext/1843106274/usb_device.d ${OBJECTDIR}/_ext/1843106274/usb_device.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1843106274/usb_device.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/_ext/1843106274/usb_device_cdc.p1: ../Includes/Usb/framework/usb_device_cdc.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1843106274" 
	@${RM} ${OBJECTDIR}/_ext/1843106274/usb_device_cdc.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1843106274/usb_device_cdc.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=32 --float=32 --emi=wordwrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/MccGenerated" -I"../Includes/Usb" -I"../Includes/Usb/framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1843106274/usb_device_cdc.p1  ../Includes/Usb/framework/usb_device_cdc.c 
	@-${MV} ${OBJECTDIR}/_ext/1843106274/usb_device_cdc.d ${OBJECTDIR}/_ext/1843106274/usb_device_cdc.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1843106274/usb_device_cdc.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/main.p1: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/main.p1.d 
	@${RM} ${OBJECTDIR}/main.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=32 --float=32 --emi=wordwrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/MccGenerated" -I"../Includes/Usb" -I"../Includes/Usb/framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/main.p1  main.c 
	@-${MV} ${OBJECTDIR}/main.d ${OBJECTDIR}/main.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/main.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=none  --double=32 --float=32 --emi=wordwrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/MccGenerated" -I"../Includes/Usb" -I"../Includes/Usb/framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"       --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.map  --double=32 --float=32 --emi=wordwrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/MccGenerated" -I"../Includes/Usb" -I"../Includes/Usb/framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote_SigMap.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
